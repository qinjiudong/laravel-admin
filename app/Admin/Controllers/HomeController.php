    ...
    public function index()
    {
        ...
        return Admin::content(function (Content $content) {
            ...
            $content->row(function ($row) use($data) {
                $row->column(3, new InfoBox('当天', 'file', 'red', 'admin/users', $data['当天']));
                $row->column(3, new InfoBox('本月', 'file', 'red', 'admin/users', $data['本月']));
                $row->column(3, new InfoBox('上月', 'file', 'red', 'admin/users', $data['上月']));
                $row->column(3, new InfoBox('总计', 'file', 'red', 'admin/users', $data['总计']));
            });
